...
This principle is the key:
the upper level defines the logical space of the lower level.
...
If additional information arrives that contradicts or extends this idea,
the system adjusts the whole structure —but maintains overall coherence around the C Tensor.
